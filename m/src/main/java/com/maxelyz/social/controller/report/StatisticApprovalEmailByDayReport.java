 ...
 */
public class StatisticApprovalEmailByDayReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticApprovalEmailByDayReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soapprovalemailbyday:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticApprovalEmailByDay.xlsx";
    }
