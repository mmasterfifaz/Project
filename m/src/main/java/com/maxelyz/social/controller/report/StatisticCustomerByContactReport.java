...
@ManagedBean
@ViewScoped
public class StatisticCustomerByContactReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticCustomerByContactReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:socustomerbycontact:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticCustomerByContact.xlsx";
    }
