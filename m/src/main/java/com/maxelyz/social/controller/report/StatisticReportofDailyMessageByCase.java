...
@ManagedBean
@ViewScoped
public class StatisticReportofDailyMessageByCase extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticReportofDailyMessageByCase.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:sodailymsgbycase:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\StatisticReportofDailyMessageByCase.xlsx";
    }
    ...
    public String getQuery() {
        ...
        */
        ...
        System.out.println("User Group ID:" + groupName);
            ...
            while(iT.hasNext()){
                ...
                // Calculate Total month in result set S
                    if(resultArray[36] !=null && Integer.parseInt(resultArray[36].toString()) == 9999){
                        ...
                        cell.setCellValue("Total Cases: " + resultArray[32]); 
