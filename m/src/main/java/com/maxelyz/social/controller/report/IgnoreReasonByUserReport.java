 ...
 */
public class IgnoreReasonByUserReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(IgnoreReasonByUserReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soignorereasonbyuser:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\ignoreReasonByUser.xlsx";
    }
