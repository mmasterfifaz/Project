 ...
 */
public class SlaPerformanceByUserReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(SlaPerformanceByUserReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soslaperformancebyuser:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\slaPerformanceByUser.xlsx";
    }
