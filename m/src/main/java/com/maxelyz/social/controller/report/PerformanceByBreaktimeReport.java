 ...
 */
public class PerformanceByBreaktimeReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(PerformanceByBreaktimeReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soperformancebybreaktime:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\performanceByBreaktime.xlsx";
    }
