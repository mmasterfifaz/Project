 ...
 */
public class ApprovalReasonByUserReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(ApprovalReasonByUserReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soapprovalreasonbyuser:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\approvalReasonByUser.xlsx";
    }
