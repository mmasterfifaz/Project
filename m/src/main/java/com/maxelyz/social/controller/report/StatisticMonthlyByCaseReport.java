...
@ManagedBean
@ViewScoped
public class StatisticMonthlyByCaseReport extends AbstractSocialReportBaseController {
    
    private static Logger log = Logger.getLogger(StatisticMonthlyByCaseReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somonthlymsgbycase:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticMonthlyByCase.xlsx";
    }
