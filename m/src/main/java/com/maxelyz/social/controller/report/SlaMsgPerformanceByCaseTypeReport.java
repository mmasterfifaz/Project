 ...
 */
public class SlaMsgPerformanceByCaseTypeReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(SlaMsgPerformanceByCaseTypeReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somsgperformancebycase:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\slaMsgPerformanceByCaseType.xlsx";
    }
