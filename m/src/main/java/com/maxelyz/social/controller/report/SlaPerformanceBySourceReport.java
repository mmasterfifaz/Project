 ...
 */
public class SlaPerformanceBySourceReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(SlaPerformanceBySourceReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soslaperformancebysource:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\slaPerformanceBySource.xlsx";
    }
