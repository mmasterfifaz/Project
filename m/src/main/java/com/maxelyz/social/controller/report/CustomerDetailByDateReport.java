 ...
 */
public class CustomerDetailByDateReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(CustomerDetailByDateReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:socustomerdetailbydate:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\customerDetailByDate.xlsx";
    }
