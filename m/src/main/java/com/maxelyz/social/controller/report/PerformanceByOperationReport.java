 ...
 */
public class PerformanceByOperationReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(PerformanceByOperationReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soperformancebyoperation:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\performanceByOperation.xlsx";
    }
