...
@ManagedBean
@ViewScoped
public class AgentByCaseTypeReport extends AbstractSocialReportBaseController {
    
    private static Logger log = Logger.getLogger(AgentByCaseTypeReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soagentbycasetype:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\agentByCaseType.xlsx";
    }
