 ...
 */
public class AgentPerformanceByPeriodReport  extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(AgentPerformanceByPeriodReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soperformancebyperiod:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\agentPerformanceByPeriod.xlsx";
    }
