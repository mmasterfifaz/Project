...
@ManagedBean
@ViewScoped
public class StatisticMsgPerformanceByPriorityReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticMsgPerformanceByPriorityReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somsgperformancebypriority:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticMsgPerformanceByPriority.xlsx";
    }
