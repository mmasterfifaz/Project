 ...
 */
public class ForwardMsgByDateReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(ForwardMsgByDateReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soforwardmsgbydate:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\forwardMsgByDate.xlsx";
    }
