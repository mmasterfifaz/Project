...
@ManagedBean
@ViewScoped
public class StatisticMsgPerformanceByPriorityTimeReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticMsgPerformanceByPriorityTimeReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somsgperformancebyprioritytime:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticMsgPerformanceByPriorityTime.xlsx";
    }
