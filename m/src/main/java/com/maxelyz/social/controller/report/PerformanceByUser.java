...
@ManagedBean
@ViewScoped
public class PerformanceByUser extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(PerformanceByUser.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soperformancebyuser:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\PerformaceByUser.xlsx";
    }
