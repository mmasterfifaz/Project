...
@ManagedBean
@ViewScoped
public class StatisticAgentPerformanceByDateReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticAgentPerformanceByDateReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soperformancebydate:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticAgentPerformanceByDate.xlsx";
    }
