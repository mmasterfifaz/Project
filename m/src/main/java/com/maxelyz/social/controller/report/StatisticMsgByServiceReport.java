 ...
 */
public class StatisticMsgByServiceReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticMsgByServiceReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somsgbyservice:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticMsgByService.xlsx";
    }
