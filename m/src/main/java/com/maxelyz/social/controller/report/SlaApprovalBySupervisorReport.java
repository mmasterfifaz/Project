 ...
 */
public class SlaApprovalBySupervisorReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(SlaApprovalBySupervisorReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soslaapprovalbysup:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\slaApprovalBySupervisor.xlsx";
    }
