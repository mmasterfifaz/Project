 ...
 */
public class StatisticMsgByCustomerReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(StatisticMsgByCustomerReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:somsgbycustomer:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\statisticMsgByCustomer.xlsx";
    }
