 ...
 */
public class SlaPerformanceByCustomerTypeReport extends AbstractSocialReportBaseController {
    private static Logger log = Logger.getLogger(SlaPerformanceByCustomerTypeReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:soslaperformancebycustomer:view")) {
    ...
    public String getXLSTemplatePath() {
        return "\\socialreport\\slaPerformanceByCustomerType.xlsx";
    }
