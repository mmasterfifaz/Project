...
public class CreditCardValidator implements Validator, Serializable {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) {
        ...
        if(cardNumber.equals("0000000000000000") || !luhnCheck(cardNumber)) {
            FacesMessage message= new FacesMessage("Invalid Card Number");
            message.setSeverity(FacesMessage.SEVERITY_ERROR); 
            //ocale locale = context.getViewRoot().getLocale(); 
