...
public class DeclarationInfoValue<T> {
    ...
    private Map<String, DeclarationField> declarMap = new ConcurrentHashMap<String, DeclarationField>();
    private T poDeclaration; //PurchaseOrderDeclaration
    private int declarationNo = 0;
    private String declarationName = "";
    private Boolean declarationEnable = false;
    /*
    ...
    */
    ...
    public DeclarationInfoValue(DeclarationForm declarationForm, List<DeclarationField> declarationFields, int declarationNo, T poDeclaration, String pageForm) throws NonexistentEntityException {
        boolean found = false;
        ...
        for (DeclarationField f : declarationFields) {
            //if (groupNo == f.getGroupNo()) {
                declarMap.put(f.getName(), f);
                found = true;
            //}
        }
        if (!found) {
        ...
        this.poDeclaration = poDeclaration;
        PurchaseOrderDeclaration po = (PurchaseOrderDeclaration) poDeclaration;
        this.declarationEnable = po.getEnable();
/*
        if (tpor != null) {
            po = tpor;
            try {
...
*/
    ...
    public T getPoDeclaration() {
        return poDeclaration;
    }

    public void setPoDeclaration(T po) {
        this.poDeclaration = po;
    }
/*    
    public T getPo() {
        return poDeclaration;
...
*/
    private String getField(String fieldName, String defaultLabel) {
        String result = null;
        DeclarationField f = declarMap.get(fieldName);
        if (f != null) {
...
/*
    ...
    private List getDistrictList1(Integer provinceId) {
        List districtList = null;
        if(provinceId != 0 && provinceId != null){
            districtList = districtDAO.findDistrictByProvinceId1(provinceId);
        }
        return districtList;
    }
    ...
    private List getSubDistrictList1(Integer districtId) {
        List subDistrictList = null;
        if(districtId != 0 && districtId != null) {
            subDistrictList = subdistrictDAO.findSubDistrictByDistrictId1(districtId); 
        }
...
*/    
    ...
    public final void setFlexFields(String pageForm) {
        ...
        for (int i = 0; i < MAX_FLEX_FIELD; i++) {
            ...
            if (fx != null) {
                ...
                String poFlexField = getPoFlexField(poDeclaration, i + 1);
    ...
    private String getPoFlexField(T poDeclaration, int no) {
        String str = "";
        if (poDeclaration instanceof PurchaseOrderDeclaration) {
            PurchaseOrderDeclaration po = (PurchaseOrderDeclaration) poDeclaration;
            switch (no) {
                case 1:
                    str = po.getFx1();
...
*/
    ...
    public Map<String, DeclarationField> getDeclarMap() {
        return declarMap;
    }

    public void setDeclarMap(Map<String, DeclarationField> declarMap) {
        this.declarMap = declarMap;
    }
    ...
    public Boolean getDeclarationEnable() {
        return declarationEnable;
    }
    
    public void setDeclarationEnable(Boolean declarationEnable) {
        this.declarationEnable = declarationEnable;
    }
