 ...
 */
@Entity
@Table(name = "purchase_order_child_register")
@NamedQueries({
    @NamedQuery(name = "PurchaseOrderChildRegister.findAll", query = "SELECT p FROM PurchaseOrderChildRegister p")})
public class PurchaseOrderChildRegister implements Serializable {
    ...
    public PurchaseOrderChildRegister() {
    }

    public PurchaseOrderChildRegister(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        if (!(object instanceof PurchaseOrderChildRegister)) {
            return false;
        }
        PurchaseOrderChildRegister other = (PurchaseOrderChildRegister) object;
    ...
    public String toString() {
        return "com.maxelyz.core.model.entity.PurchaseOrderChildForm[id=" + id + "]";
    }
