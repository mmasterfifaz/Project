...
public class CaseAttachment implements Serializable {
    ...
    public ContactCase getCaseId() {
        return caseId;
    }

    public void setCaseId(ContactCase caseId) {
        this.caseId = caseId;
    }
    ...
    public String toString() {
        return "com.maxelyz.core.model.entity.CaseAttachment[id=" + id + "]";
    }
