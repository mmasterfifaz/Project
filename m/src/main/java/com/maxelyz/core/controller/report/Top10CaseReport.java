...
@RequestScoped
@ViewScoped
public class Top10CaseReport extends AbstractReportBaseController {

    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:top10case:view")) {
    ...
    public String getReportPath() {
        return "/report/top10case.jasper";
    }
    ...
    public String getQuery() {
        ...
        String select = "SELECT top 10 c.name AS case_type_name, b.name as case_topic_name, a.name as case_detail_name, r.name as case_request_name, SUM(total) as total "
        ...
        String orderBy = "order by SUM(total) desc ";
