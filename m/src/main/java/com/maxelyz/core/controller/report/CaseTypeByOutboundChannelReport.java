...
@RequestScoped
@ViewScoped
public class CaseTypeByOutboundChannelReport extends AbstractReportBaseController {
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:contactsummarybyoutboundchannel:view")) {
    ...
    public String getReportPath() {
        return "/report/casetypeByOutboundChannel.jasper";
    }
    ...
    public String getQuery() {
        ...
        String select = "SELECT c.name AS case_type_name, d.name AS channel_name, sum(rpt.total) AS total "
        ...
        where += "AND d.type = 'Outbound' ";
        String groupBy = "GROUP BY d.name, c.name ";
