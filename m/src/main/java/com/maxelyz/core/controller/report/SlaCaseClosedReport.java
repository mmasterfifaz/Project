...
@RequestScoped
@ViewScoped
public class SlaCaseClosedReport extends AbstractReportBaseController {
    private static Logger log = Logger.getLogger(SlaCaseClosedReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:slacaseclosedbycasetype:view")) {
    ...
    public String getReportPath() {
        return "/report/slaCaseClosed.jasper";
    }
    ...
    public String getQuery() {
        ...
        String select = "SELECT c.name AS case_type, b.name as case_topic, a.name as case_detail, "
                ...
                + "INNER JOIN users AS u ON u.id = rpt.user_id INNER JOIN "
