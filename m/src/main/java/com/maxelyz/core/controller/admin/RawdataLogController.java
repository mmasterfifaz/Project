...
//@RequestScoped
@ViewScoped
public class RawdataLogController implements Serializable{

    private static String REFRESH = "rawdatalog.xhtml?faces-redirect=true";
    private static String EDIT = "rawdatalog.xhtml";
    private static String SELECT = "rawdatalog.xhtml";
    private static Log log = LogFactory.getLog(RawdataLogController.class);
   ...
   /* @ManagedProperty(value="#{productPlanDetailDAO}")
    ...
    public void initialize() {
        if (!SecurityUtil.isPermitted("admin:rawdatafile:view")) {
            SecurityUtil.redirectUnauthorize();  
        }
                
//        yesLogs = yesLogDAO.findYesLogEntitiesDesc();
        yesLogs = yesLogDAO.findYesLogByTypeDesc(false, 1, 1, 3);
    }
