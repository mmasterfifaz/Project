...
@ManagedBean
@RequestScoped
public class MKTListPerformanceByProductTypeReport extends AbstractReportBaseController {

    private static Logger log = Logger.getLogger(MKTListPerformanceByProductTypeReport.class);

    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:marketinglistbyproducttype:view")) {
    ...
    public String getReportPath() {
        return "/report/marketinglistbyproducttype.jasper";
    }
