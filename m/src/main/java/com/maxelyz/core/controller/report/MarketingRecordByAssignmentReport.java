...
@ManagedBean
@RequestScoped
public class MarketingRecordByAssignmentReport extends AbstractReportBaseController {
    private static Logger log = Logger.getLogger(MarketingRecordByAssignmentReport.class);
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:marketingrecordbyassignment:view")) {
    ...
    public String getReportPath() {
        return "/report/marketingrecordbyassignment.jasper";
    }
