...
//@RequestScoped
@ViewScoped
public class CaseTypeByInboundChannelReport extends AbstractReportBaseController {
    private static Logger log = Logger.getLogger(CaseTypeByInboundChannelReport.class);
    private Integer users_id;
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:contactsummarybyinboundchannel:view")) {
    ...
    public String getReportPath() {
        return "/report/casetypeByInboundChannel.jasper";
    }
