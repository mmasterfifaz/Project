...
//@RequestScoped
@ViewScoped
public class PopupDocumentController implements Serializable{
    private static Logger log = Logger.getLogger(PopupDocumentController.class);
    private static String REFRESH = "popupdocument.xhtml?faces-redirect=true";
    private static String EDIT = "popupdocumentedit.xhtml";
