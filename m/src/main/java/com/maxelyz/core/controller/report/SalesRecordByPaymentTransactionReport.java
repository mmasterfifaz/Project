...
@ManagedBean
@RequestScoped
public class SalesRecordByPaymentTransactionReport   extends AbstractReportBaseController {
    private static Logger log = Logger.getLogger(SalesRecordByPaymentTransactionReport.class);
    @PostConstruct
    public void initialize() {
        if (!SecurityUtil.isPermitted("report:salerecordbypaymenttransaction:view")) {
    ...
    public String getReportPath() {
        return "/report/salesrecordbypaymenttransaction.jasper";
    }
